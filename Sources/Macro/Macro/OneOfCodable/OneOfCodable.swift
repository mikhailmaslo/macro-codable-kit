...
public struct OneOfCodableMacro: MacroMetaProviding {
    static let name: String = "OneOfCodable"
    static let domain: String = "\(Self.self)"
}

extension OneOfCodableMacro: ExtensionMacro {
